...
class Coordinator:
    def __init__(self):
        self.processed_articles_file = "scraper/data/processed_articles.json"
    ...
    def run_scraper(self):
        ...
        while True:
            try:
                ...
                subprocess.run(["python", "scraper/run_optimized_scrapers.py"], check=True)
    ...
    def process_new_articles(self):
        ...
        while True:
            try:
                ...
                reddit_file = "scraper/articles/reddit_threads.json"
                ...
                for source, filename in news_sources.items():
                    news_file = f"scraper/articles/{filename}"
